      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">기능 알아보기</h2>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                word, hwp, PDF 등 여러 포멧으로 되어있는 계약서 파일을
                업로드하여 수정 관리 가능한 전자 계약 문서로 관리하세요.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                계약서 주요 수정 히스토리를 쉽고 빠르게 클라우드에 보관하고 또
                불러올 수 있습니다.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                계약서 이해 당사자간 수정 요청 제안 내용을 쉽게 인라인으로 주고
                받을 수 있어요.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                강력한 AWS 보안 기능과 함께, 모든 계약서 정보는 암호화되어
                저장됩니다. 또한 모든 데이터 전송은 TLS 암호화 프로토콜을 통해
                보호됩니다.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                현재 계약서를 누가 언제까지 검토해야 하는지, 어떤 계약서가
                누구에게 할당되어 있는지 등을 한눈에 확인할 수 있습니다.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                협의된 계약서를 깔끔하게 출력하여, 서명을 받거나 보관할 수
                있습니다.
              </p>
            </div>
          </div>
